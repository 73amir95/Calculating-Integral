...
public class Integral3TestProgram extends PApplet{
	public static void main(String[] args) {
		PApplet.main(calculating_integral.Integral3TestProgram.class);
	}
	...
	public void setup() {
		...
		double i = in.getIntegral3();
		System.out.println("The approximated integral with the third method is: " +i);
